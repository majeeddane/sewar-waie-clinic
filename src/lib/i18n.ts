...
const ar = {
  ...
  testimonials: {
    ...
    items: [
      {
        name: 'محمد ع.',
        text: 'تجربتي في سوار وعي غيّرت حياتي تماماً. الفريق هنا جعلني أشعر بأنني لست وحيد، وساعدوني على استعادة ثقتي بنفسي.',
      },
      {
        name: 'فاطمة س.',
  ...
  aboutPage: {
    ...
    values: [
      ...
      { name: 'الرحمة', desc: 'نتعامل مع كل حالة بتعاطف واحترام' },
    ],
